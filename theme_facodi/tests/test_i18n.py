    ...
    def test_builder_snippet_copy_uses_native_translations(self):
        ...
        expected_by_lang = {
            "en_US": (
                ...
                "Roadmap",
                "Curricular unit",
                "Find verified academic context.",
                "Course",
            ...
            "pt_PT": (
                ...
                "Roadmap",
                "Unidade curricular",
                "Encontra contexto académico verificado.",
                "Curso",
            ...
            "es_ES": (
                ...
                "Ruta",
                "Unidad curricular",
                "Encuentra contexto académico verificado.",
                "Curso",
                "Sigue el hilo útil.",
            ),
            "fr_FR": (
                ...
                "Trouve un contexte académique vérifié.",
                "Cours",
                "Continue à suivre le fil utile.",
            ),
        }
