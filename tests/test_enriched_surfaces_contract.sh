...
grep -Fq '"version": "19.0.10.3.0"' "$MANIFEST" || fail "enriched release version missing"
for selector in '.o_portal_my_home' '.facodi-contribution-dashboard' '[data-facodi-community-videos="1"]' '.facodi-empty-state' '.o_wforum_post_reply' '.o_wslides_course_card' '.facodi-learning-meta'; do
